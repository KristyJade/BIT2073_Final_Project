...
### *Fast Food. Simple Ordering. Better Experience.*

**BIT2073 | Human Computer Interaction | Final Project**

An interactive food delivery website designed around **usability, simplicity, accessibility, and user experience**.
...
| **Project Name** | Whack Food Corner |
| **Group** | Group 3 |
...
| No. | Name | Student ID |
|---:|---|---|
| 1 | **Kristy Jade Luther** | 202307010100 |
| 2 | **Wan Jalalularif Bin Wan Mohd Anuar** | 202307010067 |
| 3 | **Thilak A/L Kamalish Kumar** | 202309010104 |
| 4 | **Venush A/L Kumar** | 202309010172 |
| 5 | **Muhammad Aiman Hakimi Bin Khairul Hafti** | 202309010149 |

---

## 🍟 About the Project

**Whack Food Corner** is an interactive food delivery website developed to provide users with a simple, organized, and convenient way to browse and order food online.

The website supports a complete ordering journey where users can **browse food categories, select products, manage their cart, add special order notes, complete checkout, select payment methods, view order status, track orders, and reorder previous purchases**.

Food items are organized into **Burgers, Chicken Delights, and Drinks**, with product images, descriptions, and prices provided to help users understand and compare available choices.

The website applies **Human Computer Interaction (HCI)** principles to create a clear, consistent, accessible, and user-friendly ordering experience.

---

## 🎯 Project Objectives

The main objective of Whack Food Corner is to develop an **interactive, user-friendly, and well-structured food delivery website** that combines practical ordering functions with HCI principles.

The project aims to:

- Develop a **clear and consistent user interface**
- Provide a **complete and structured food ordering process**
- Apply important **Human Computer Interaction principles**
- Provide **interactive functions and clear system responses**
- Improve user control throughout the ordering experience

---

## 👤 Target Users

Whack Food Corner is designed for users who prefer a quick, convenient, and understandable way to order food online.

| Target User | Main Need |
|---|---|
| 🎓 **Students** | Quick and convenient ordering around busy study schedules |
| 💼 **Working Adults** | Efficient browsing and ordering with minimal steps |
| 🛍️ **Regular Online Customers** | Organized menus, cart controls, checkout, and order management |
| 🆕 **First-Time Users** | Clear navigation and recognizable ordering actions |
| 👥 **General Customers** | Convenient access to food and restaurant information |
